...
void time_choice(struct marcacao * current, struct marcacao *old, char * med);
void assign_time_by_apt(struct marcacao * current, struct marcacao *old, char * med);
